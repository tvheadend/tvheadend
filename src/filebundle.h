...
/* Bundle or Direct */
typedef enum filebundle_handle_type { FB_BUNDLE, FB_DIRECT } fb_type;

/* File bundle entry type */
enum filebundle_type { FB_UNKNOWN, FB_FILE, FB_DIR };
...
fb_file*
         fb_open2(const fb_dir* dir, const char* name, int decompress, int compress);
