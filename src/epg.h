...
struct epg_broadcast {
  ...
  lang_str_t* credits_cached; ///< Comma separated cast (for regex searching in GUI/autorec). Kept
                              ///< in sync with cast_map
  string_list_t* category; ///< Extra categories (typically from xmltv) such as "Western" or "Sumo
                           ///< Wrestling". These extra categories are often a superset of our EN
                           ///< 300 468 DVB genre. Used with drop-down lists in the GUI.
  string_list_t*
              keyword; ///< Extra keywords (typically from xmltv) such as "Wild West" or "Unicorn".
  ...
  uint16_t
      copyright_year; ///< xmltv DTD gives a tag "date" (separate to previously-shown/first aired).
...
/* Lookup */
epg_broadcast_t* epg_broadcast_find_by_time(struct channel* ch,
...
/* Special */
epg_broadcast_t* epg_broadcast_clone(struct channel* channel, epg_broadcast_t* src, int* save);

/* Mutators */
int epg_broadcast_set_dvb_eid(epg_broadcast_t* b, uint16_t dvb_eid, epg_changes_t* changed)
    __attribute__((warn_unused_result));
int epg_broadcast_set_running(epg_broadcast_t* b, epg_running_t running)
    __attribute__((warn_unused_result));
...
int epg_broadcast_set_is_repeat(epg_broadcast_t* b, uint8_t r, epg_changes_t* changed)
    __attribute__((warn_unused_result));
int epg_broadcast_set_title(epg_broadcast_t* b, const lang_str_t* str, epg_changes_t* changed)
    __attribute__((warn_unused_result));
int epg_broadcast_set_subtitle(epg_broadcast_t* b, const lang_str_t* str, epg_changes_t* changed)
    __attribute__((warn_unused_result));
int epg_broadcast_set_summary(epg_broadcast_t* b, const lang_str_t* str, epg_changes_t* changed)
    __attribute__((warn_unused_result));
int epg_broadcast_set_description(epg_broadcast_t* b, const lang_str_t* str, epg_changes_t* changed)
    __attribute__((warn_unused_result));
int epg_broadcast_set_credits(epg_broadcast_t* b, const htsmsg_t* msg, epg_changes_t* changed)
    __attribute__((warn_unused_result));
int epg_broadcast_set_category(epg_broadcast_t* b, const string_list_t* msg, epg_changes_t* changed)
    __attribute__((warn_unused_result));
int epg_broadcast_set_keyword(epg_broadcast_t* b, const string_list_t* msg, epg_changes_t* changed)
    __attribute__((warn_unused_result));
int epg_broadcast_set_serieslink_uri(epg_broadcast_t* b, const char* uri, epg_changes_t* changed)
    __attribute__((warn_unused_result));
int epg_broadcast_set_episodelink_uri(epg_broadcast_t* b, const char* uri, epg_changes_t* changed)
    __attribute__((warn_unused_result));
...
int epg_broadcast_set_eppart(epg_broadcast_t* b,
    uint16_t                                  number,
    uint16_t                                  count,
    epg_changes_t*                            changed) __attribute__((warn_unused_result));
int epg_broadcast_set_epnum(epg_broadcast_t* b, epg_episode_num_t* num, epg_changes_t* changed)
    __attribute__((warn_unused_result));
int epg_broadcast_set_genre(epg_broadcast_t* b, epg_genre_list_t* g, epg_changes_t* changed)
    __attribute__((warn_unused_result));
int epg_broadcast_set_image(epg_broadcast_t* b, const char* i, epg_changes_t* changed)
    __attribute__((warn_unused_result));
...
int epg_broadcast_set_star_rating(epg_broadcast_t* b, uint8_t stars, epg_changes_t* changed)
    __attribute__((warn_unused_result));
int epg_broadcast_set_copyright_year(epg_broadcast_t* b, uint16_t stars, epg_changes_t* changed)
    __attribute__((warn_unused_result));
...
void   epg_broadcast_get_epnum(const epg_broadcast_t* b, epg_episode_num_t* epnum);
...
static inline int epg_episode_match(epg_broadcast_t* a, epg_broadcast_t* b) {
  if (a == NULL || b == NULL)
    return 0;
  if (a->episodelink == NULL || b->episodelink == NULL)
    return 0;
