 ...
 *
 */
static int htsmsg_binary_des0(htsmsg_t* msg, const uint8_t* buf, size_t len) {
  ...
  while (len > 5) {
    ...
    type    = buf[0];
    namelen = buf[1];
    datalen = (((uint_fast32_t)buf[2]) << 24) | (((uint_fast32_t)buf[3]) << 16) |
        (((uint_fast32_t)buf[4]) << 8) | (((uint_fast32_t)buf[5]));
 ...
 *
 */
htsmsg_t* htsmsg_binary_deserialize0(const void* data, size_t len, const void* buf) {
  htsmsg_t* msg;
  int       r;
 ...
 *
 */
int htsmsg_binary_deserialize(htsmsg_t** msg, const void* data, size_t* len, const void* buf) {
  htsmsg_t*      m;
  const uint8_t* p;
  uint32_t       l, len2;
 ...
 *
 */
static size_t htsmsg_binary_count(htsmsg_t* msg) {
  htsmsg_field_t* f;
  size_t          len = 0;
  uint64_t        u64;
 ...
 *
 */
static void htsmsg_binary_write(htsmsg_t* msg, uint8_t* ptr) {
  htsmsg_field_t* f;
  uint64_t        u64;
  int             l, i, namelen;
 ...
 *
 */
int htsmsg_binary_serialize0(htsmsg_t* msg, void** datap, size_t* lenp, int maxlen) {
  size_t   len;
  uint8_t* data;
 ...
 *
 */
int htsmsg_binary_serialize(htsmsg_t* msg, void** datap, size_t* lenp, int maxlen) {
  size_t   len;
  uint8_t* data;
