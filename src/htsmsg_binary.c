...
static int htsmsg_binary_des0(htsmsg_t* msg, const uint8_t* buf, size_t len) {
  ...
  while (len > 5) {
    ...
    datalen = (((uint_fast32_t)buf[2]) << 24) |
        (((uint_fast32_t)buf[3]) << 16) | (((uint_fast32_t)buf[4]) << 8) |
        (((uint_fast32_t)buf[5]));
 ...
 *
 */
int htsmsg_binary_deserialize(htsmsg_t** msg,
    const void*                          data,
    size_t*                              len,
    const void*                          buf) {
  htsmsg_t*      m;
 ...
 *
 */
int htsmsg_binary_serialize0(htsmsg_t* msg,
    void**                             datap,
    size_t*                            lenp,
    int                                maxlen) {
  size_t   len;
 ...
 *
 */
int htsmsg_binary_serialize(htsmsg_t* msg,
    void**                            datap,
    size_t*                           lenp,
    int                               maxlen) {
  size_t   len;
