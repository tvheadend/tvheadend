...
enum signal_status_scale {
  ...
  SIGNAL_STATUS_SCALE_RELATIVE, // value is unsigned, where 0 means 0% and 65535
                                // means 100%
...
static inline void streaming_target_deliver(streaming_target_t* st,
...
static inline int streaming_pad_probe_type(streaming_pad_t* sp,
