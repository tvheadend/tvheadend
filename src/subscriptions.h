...
typedef struct th_subscription {
  ...
  uint64_t ths_total_bytes_in_prev;  /* total bytes since the subscription
                                        started, minus 1 second */
  uint64_t ths_total_bytes_out_prev; /* total bytes since the subscription
                                        started, minus 1 second */
...
th_subscription_t* subscription_create_from_channel(struct profile_chain* prch,
    struct tvh_input*                                                     ti,
    unsigned int weight,
    const char*  name,
    int          flags,
...
th_subscription_t* subscription_create_from_service(struct profile_chain* prch,
    struct tvh_input*                                                     ti,
    unsigned int weight,
    const char*  name,
    int          flags,
...
#if ENABLE_MPEGTS
struct tvh_input;
th_subscription_t* subscription_create_from_mux(struct profile_chain* prch,
    struct tvh_input*                                                 ti,
    unsigned int                                                      weight,
    const char*                                                       name,
    int                                                               flags,
