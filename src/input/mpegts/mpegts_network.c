...
static htsmsg_t*
mpegts_network_class_save(idnode_t* in, char* filename, size_t fsize) {
...
static void mpegts_network_class_get_title(idnode_t* in,
    const char*                                      lang,
    char*                                            dst,
    size_t                                           dstsize) {
  mpegts_network_t* mn = (mpegts_network_t*)in;
...
static void
mpegts_network_display_name(mpegts_network_t* mn, char* buf, size_t len) {
...
void mpegts_network_bouquet_trigger0(mpegts_network_t* mn, int timeout) {
  mtimer_arm_rel(&mn->mn_bouquet_timer,
      mpegts_network_bouquet_update,
      mn,
      sec2mono(timeout));
}

static int
mpegts_network_bouquet_source(mpegts_network_t* mn, char* source, size_t len) {
...
static int mpegts_network_bouquet_comment(mpegts_network_t* mn,
    char*                                                   comment,
    size_t                                                  len) {
...
static htsmsg_t*
mpegts_network_config_save(mpegts_network_t* mn, char* filename, size_t size) {
...
static mpegts_service_t* mpegts_network_create_service(mpegts_mux_t* mm,
    uint16_t                                                         sid,
    uint16_t                                                         pmt_pid) {
  return NULL;
}
...
static mpegts_mux_t* mpegts_network_mux_create2(mpegts_network_t* mn,
    htsmsg_t*                                                     conf) {
  return NULL;
}
