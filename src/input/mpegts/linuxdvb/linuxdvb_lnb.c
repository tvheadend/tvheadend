...
static void linuxdvb_lnb_class_get_title(idnode_t* o,
    const char*                                    lang,
    char*                                          dst,
    size_t                                         dstsize) {
...
static int linuxdvb_lnb_bandstack_match(linuxdvb_lnb_t* l,
    dvb_mux_t*                                          lm1,
    dvb_mux_t*                                          lm2) {
...
static int
linuxdvb_lnb_standard_match(linuxdvb_lnb_t* l, dvb_mux_t* lm1, dvb_mux_t* lm2) {
  linuxdvb_lnb_conf_t* lnb  = (linuxdvb_lnb_conf_t*)l;
...
linuxdvb_lnb_conf_t linuxdvb_lnb_all[] = {
    ...
    },
    {
        ...
        .lnb_low    = 5150000,
        .lnb_high   = 10750000,
        .lnb_switch = 11700000, /* 10750 + 950 (bottom of the receiver range
                                   950Mhz-2150Mhz) */
    },
    {
        {
