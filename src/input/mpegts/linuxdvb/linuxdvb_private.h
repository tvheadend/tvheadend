...
typedef TAILQ_HEAD(linuxdvb_satconf_ele_list,
    linuxdvb_satconf_ele) linuxdvb_satconf_ele_list_t;
#if ENABLE_LINUXDVB_CA
typedef TAILQ_HEAD(linuxdvb_ca_write_queue,
    linuxdvb_ca_write) linuxdvb_ca_write_queue_t;
#endif
...
struct linuxdvb_en50494 {
  ...
  uint32_t
      le_cmd_time; /* time to wait for command to complete in milliseconds */
  ...
  uint16_t
      le_position; /* satelitte position (0-1 for EN50494, 0-63 for EN50607) */
...
void linuxdvb_frontend_add_network(linuxdvb_frontend_t* lfe,
    linuxdvb_network_t*                                 net);
...
linuxdvb_lnb_t*    linuxdvb_lnb_create0(const char* name,
       htsmsg_t*                                    conf,
       linuxdvb_satconf_ele_t*                      ls);
linuxdvb_diseqc_t* linuxdvb_switch_create0(const char* name,
    htsmsg_t*                                          conf,
    linuxdvb_satconf_ele_t*                            ls,
    int                                                c,
    int                                                u);
...
linuxdvb_diseqc_t* linuxdvb_en50494_create0(const char* name,
    htsmsg_t*                                           conf,
    linuxdvb_satconf_ele_t*                             ls,
    int                                                 port);
