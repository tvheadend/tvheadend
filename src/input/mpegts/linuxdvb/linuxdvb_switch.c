...
static htsmsg_t* linuxdvb_switch_class_committed_list(void* o,
    const char*                                             lang) {
...
static htsmsg_t* linuxdvb_switch_class_uncommitted_list(void* o,
    const char*                                               lang) {
  static const struct strtab tab[] = {
      {N_("NONE"), -1},
      {N_("0"), 0},
...
static htsmsg_t* linuxdvb_switch_class_toneburst_list(void* o,
    const char*                                             lang) {
  static const struct strtab tab[] = {
      {N_("NONE"), -1},
      {N_("A"), 0},
...
static void linuxdvb_switch_class_get_title(idnode_t* o,
    const char*                                       lang,
    char*                                             dst,
    size_t                                            dstsize) {
...
const idclass_t linuxdvb_switch_class = {.ic_super = &linuxdvb_diseqc_class,
...
static int linuxdvb_switch_tune(linuxdvb_diseqc_t* ld,
    dvb_mux_t*                                     lm,
...
htsmsg_t* linuxdvb_switch_list(void* o, const char* lang) {
  ...
  htsmsg_add_msg(m,
      NULL,
      htsmsg_create_key_val("Generic", tvh_gettext_lang(lang, N_("Generic"))));
  return m;
}
...
linuxdvb_diseqc_t* linuxdvb_switch_create0(const char* name,
  ...
  if (!strcmp(name ?: "", "Generic")) {
    ld = (linuxdvb_switch_t*)
        linuxdvb_diseqc_create(linuxdvb_switch, NULL, conf, "Generic", ls);
    if (ld) {
