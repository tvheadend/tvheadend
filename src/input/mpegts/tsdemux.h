...
void ts_recv_packet0(struct mpegts_service* t,
    elementary_stream_t*                    st,
    const uint8_t*                          tsb,
    int                                     len);

int ts_recv_packet1(struct mpegts_service* t,
    uint64_t                               tspos,
    uint16_t                               pid,
    const uint8_t*                         tsb,
    int                                    len,
...
void ts_recv_raw(struct mpegts_service* t, uint64_t tspos, const uint8_t* tsb, int len);
