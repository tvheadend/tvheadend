...
static inline void iptv_url_set0(char** url,
    char**                              sane_url,
    const char*                         url1,
    const char*                         sane_url1) {
  free(*url);
  free(*sane_url);
...
const idclass_t iptv_mux_class = {.ic_super = &mpegts_mux_class,
    ...
    .ic_properties                          = (const property_t[]){
        ...
        {.type    = PT_STR,
            ...
            .desc =
                N_("Manually setup a retransmission URL for Multicast streams."
        ...
        {.type    = PT_U32,
            ...
            .desc = N_("For example: 12610500. This frequency is 12610.5Mhz or "
                       "12.6105Ghz."),
            .opts = PO_ADVANCED},
        {
            .type = PT_U32,
