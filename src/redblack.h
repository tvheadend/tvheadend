...
#define RB_REMOVE(head, e, field)                                                              \
  do {                                                                                         \
    ...
    if (y->field.color != RB_TREE_NODE_RED) {                                                  \
      while (x != (head)->root && (x == NULL || x->field.color == RB_TREE_NODE_BLACK)) {       \
        if (x == x_parent->field.left) {                                                       \
          ...
          if ((w->field.left == NULL || w->field.left->field.color == RB_TREE_NODE_BLACK) &&   \
              (w->field.right == NULL || w->field.right->field.color == RB_TREE_NODE_BLACK)) { \
                                                                                               \
            w->field.color = RB_TREE_NODE_RED;                                                 \
            x              = x_parent;                                                         \
            x_parent       = x_parent->field.parent;                                           \
          } else {                                                                             \
            if (w->field.right == NULL || w->field.right->field.color == RB_TREE_NODE_BLACK) { \
                                                                                               \
              if (w->field.left) {                                                             \
          ...
          if ((w->field.right == NULL || w->field.right->field.color == RB_TREE_NODE_BLACK) && \
              (w->field.left == NULL || w->field.left->field.color == RB_TREE_NODE_BLACK)) {   \
                                                                                               \
            w->field.color = RB_TREE_NODE_RED;                                                 \
            x              = x_parent;                                                         \
            x_parent       = x_parent->field.parent;                                           \
