...
const lang_code_t lang_codes[] = {{"und", NULL, NULL, "Undetermined"},
    {"aar", "aa", NULL, "Afar"},
...
static int _lang_code_lookup_add(lang_code_lookup_t* lookup_table,
    const lang_code_t*                               code,
    int (*func)(void*, void*)) {
  lang_code_lookup_element_t* element;
  element            = (lang_code_lookup_element_t*)calloc(1,
      sizeof(lang_code_lookup_element_t));
...
static const lang_code_t* _lang_code_get(const char* code, size_t len) {
  ...
  if (lang_codes_code2b == NULL) {
    ...
    lang_codes_code2b =
        (lang_code_lookup_t*)calloc(1, sizeof(lang_code_lookup_t));
    lang_codes_code1 =
        (lang_code_lookup_t*)calloc(1, sizeof(lang_code_lookup_t));
    lang_codes_code2t =
        (lang_code_lookup_t*)calloc(1, sizeof(lang_code_lookup_t));
    ...
    while (c->code2b) {
      ...
      if (c->code1)
        _lang_code_lookup_add(lang_codes_code1, c, _lang_code1_cmp);
      if (c->code2t)
        _lang_code_lookup_add(lang_codes_code2t, c, _lang_code2t_cmp);
      c++;
    }
  }
