...
char*       intlconv_charset_id(const char* charset,
          int                               transil,
          int                               ignore_bad_chars);
ssize_t     intlconv_utf8(char* dst,
        size_t                  dst_size,
        const char*             dst_charset_id,
        const char*             src_utf8);
char*       intlconv_utf8safestr(const char* dst_charset_id,
          const char*                        src_utf8,
          size_t                             max_size);
...
char* intlconv_to_utf8safestr(const char* src_charset_id,
    const char*                           src_str,
    size_t                                max_size);
