...
static int _lang_str_add(lang_str_t* ls, const char* str, const char* lang, int cmd) {
  int             save = 0;
  lang_str_ele_t *e, *ae;
...
void lang_str_serialize_one(htsmsg_t* m, const char* f, const char* str, const char* lang) {
