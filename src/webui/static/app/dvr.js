...
tvheadend.dvrDetails = function(uuid) {
    ...
    function showit(d) {
        ...
        content += '<div class="x-epg-time"><div class="x-start-time-prefix">Scheduled Start Time:</div> ' + new Date(start_real * 1000).toLocaleString() + '</div>';
        content += '<div class="x-epg-time"><div class="x-stop-time-prefix">Scheduled Stop Time:</div> ' + new Date(stop_real * 1000).toLocaleString() + '</div>';
