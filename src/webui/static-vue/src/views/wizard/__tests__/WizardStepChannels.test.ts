 ...
 * /vue/ to force a fresh WS connection — see component doc).
...
describe('WizardStepChannels — Finish flow', () => {
  it('POSTs channels/save then calls wizard.cancel(), then reloads at /vue/', async () => {
