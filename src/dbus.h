...
void dbus_emit_signal(const char* obj_name,
    const char*                   sig_name,
    htsmsg_t*                     msg);
void dbus_emit_signal_str(const char* obj_name,
    const char*                       sig_name,
    const char*                       value);
void dbus_emit_signal_s64(const char* obj_name,
    const char*                       sig_name,
    int64_t                           value);
...
static inline void dbus_emit_signal_str(const char* obj_name,
    const char*                                     sig_name,
    const char*                                     value) {}
static inline void dbus_emit_signal_s64(const char* obj_name,
    const char*                                     sig_name,
    int64_t                                         value) {}

static inline void dbus_register_rpc_s64(const char* call_name,
    void*                                            opaque,
    int64_t (*fcn)(void*, const char*, int64_t)) {}

static inline void dbus_register_rpc_str(const char* call_name,
    void*                                            opaque,
    char* (*fcn)(void*, const char*, char*)) {}
