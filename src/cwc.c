...
cwc_emm_bulcrypt(cwc_t *cwc, uint8_t *data, int len)
{
  ...
  case 0x82: /* unique */
  case 0x85: /* unique */
    match = len >= 10 && memcmp(data + 3, cwc->cwc_ua, 3) == 0;
    break;
  case 0x84: /* shared */
    match = len >= 10 && memcmp(data + 3, cwc->cwc_ua, 2) == 0;
    break;
  case 0x8b: /* shared-unknown */
    match = len >= 10 && memcmp(data + 4, cwc->cwc_ua, 2) == 0;
    break;
  case 0x8a: /* global */
    match = len >= 10 && memcmp(data + 4, cwc->cwc_ua, 1) == 0;
    break;
  }
