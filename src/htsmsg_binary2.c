 ...
 *
 */
static inline uint32_t htsmsg_binary2_get_length(uint8_t const** _p,
    const uint8_t*                                               end) {
  uint32_t       r = 0;
  const uint8_t* p = *_p;
  uint8_t        c;
 ...
 *
 */
int htsmsg_binary2_deserialize(htsmsg_t** msg,
    const void*                           data,
    size_t*                               len,
    const void*                           buf) {
  htsmsg_t*      m;
 ...
 *
 */
static uint32_t htsmsg_binary2_field_length(htsmsg_field_t* f) {
  uint64_t u64;
  uint32_t l;
 ...
 *
 */
static void htsmsg_binary2_write(htsmsg_t* msg, uint8_t* ptr) {
  htsmsg_field_t* f;
  uint64_t        u64;
  int             l, i, namelen;
 ...
 *
 */
int htsmsg_binary2_serialize0(htsmsg_t* msg,
    void**                              datap,
    size_t*                             lenp,
    size_t                              maxlen) {
  uint32_t len;
 ...
 *
 */
int htsmsg_binary2_serialize(htsmsg_t* msg,
    void**                             datap,
    size_t*                            lenp,
    size_t                             maxlen) {
  uint32_t len, llen;
