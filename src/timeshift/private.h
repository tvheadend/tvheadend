...
void timeshift_packet_log0(const char* prefix, timeshift_t* ts, streaming_message_t* sm);

static inline void
timeshift_packet_log(const char* prefix, timeshift_t* ts, streaming_message_t* sm) {
...
timeshift_file_t* timeshift_filemgr_prev(timeshift_file_t* ts, int* end, int keep);
timeshift_file_t* timeshift_filemgr_next(timeshift_file_t* ts, int* end, int keep);
