...
static int api_mapper_stop(access_t* perm,
    void*                            opaque,
    const char*                      op,
    htsmsg_t*                        args,
    htsmsg_t**                       resp) {
...
static int api_mapper_status(access_t* perm,
    void*                              opaque,
    const char*                        op,
    htsmsg_t*                          args,
    htsmsg_t**                         resp) {
...
static htsmsg_t* api_service_streams_get_one(elementary_stream_t* es,
    int                                                           use_filter) {
...
static int api_service_streams(access_t* perm,
    void*                                opaque,
    const char*                          op,
    htsmsg_t*                            args,
    htsmsg_t**                           resp) {
  ...
  if (elementary_set_has_streams(&s->s_components, 1) ||
