...
static int
api_mapper_stop(access_t* perm, void* opaque, const char* op, htsmsg_t* args, htsmsg_t** resp) {
...
static htsmsg_t* api_mapper_status_msg(void) {
  htsmsg_t*               m;
...
static int
api_mapper_status(access_t* perm, void* opaque, const char* op, htsmsg_t* args, htsmsg_t** resp) {
  tvh_mutex_lock(&global_lock);
...
static htsmsg_t* api_service_streams_get_one(elementary_stream_t* es, int use_filter) {
...
static int
api_service_streams(access_t* perm, void* opaque, const char* op, htsmsg_t* args, htsmsg_t** resp) {
  const char*          uuid;
...
static int api_service_remove_unseen(access_t* perm,
    void*                                      opaque,
    const char*                                op,
    htsmsg_t*                                  args,
    htsmsg_t**                                 resp) {
