...
static int wizard_page(const char* page) {
...
static int wizard_idnode_load_simple(access_t* perm,
    void*                                      opaque,
    const char*                                op,
    htsmsg_t*                                  args,
    htsmsg_t**                                 resp) {
...
static int wizard_idnode_save_simple(access_t* perm,
    void*                                      opaque,
    const char*                                op,
    htsmsg_t*                                  args,
    htsmsg_t**                                 resp) {
...
static int
wizard_cancel(access_t* perm, void* opaque, const char* op, htsmsg_t* args, htsmsg_t** resp) {
  return wizard_page("");
}

static int
wizard_start(access_t* perm, void* opaque, const char* op, htsmsg_t* args, htsmsg_t** resp) {
  return wizard_page("hello");
}

static int wizard_status_progress(access_t* perm,
    void*                                   opaque,
    const char*                             op,
    htsmsg_t*                               args,
    htsmsg_t**                              resp) {
