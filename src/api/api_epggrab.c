...
static void api_epggrab_channel_grid(access_t* perm,
    idnode_set_t*                              ins,
...
static int api_epggrab_module_list(access_t* perm,
    void*                                    opaque,
    const char*                              op,
    htsmsg_t*                                args,
    htsmsg_t**                               resp) {
  ...
  LIST_FOREACH (mod, &epggrab_modules, link) {
    ...
    htsmsg_add_str(m,
        "title",
        idnode_get_title(&mod->idnode, perm->aa_lang_ui, buf, sizeof(buf)));
...
static int api_epggrab_ota_trigger(access_t* perm,
    void*                                    opaque,
    const char*                              op,
    htsmsg_t*                                args,
    htsmsg_t**                               resp) {
...
static int api_epggrab_rerun_internal(access_t* perm,
    void*                                       opaque,
    const char*                                 op,
    htsmsg_t*                                   args,
    htsmsg_t**                                  resp) {
