...
static int
api_status_inputs(access_t* perm, void* opaque, const char* op, htsmsg_t* args, htsmsg_t** resp) {
  int                     c = 0;
  htsmsg_t *              l, *e;
  tvh_input_t*            ti;
...
static int api_status_subscriptions(access_t* perm,
    void*                                     opaque,
    const char*                               op,
    htsmsg_t*                                 args,
    htsmsg_t**                                resp) {
...
static int api_status_connections(access_t* perm,
    void*                                   opaque,
    const char*                             op,
    htsmsg_t*                               args,
    htsmsg_t**                              resp) {
...
static int api_connections_cancel(access_t* perm,
    void*                                   opaque,
    const char*                             op,
    htsmsg_t*                               args,
    htsmsg_t**                              resp) {
...
static void input_clear_stats(const char* uuid) {
...
static int api_status_input_clear_stats(access_t* perm,
    void*                                         opaque,
    const char*                                   op,
    htsmsg_t*                                     args,
    htsmsg_t**                                    resp) {
