...
static void api_passwd_entry_grid(access_t* perm,
    idnode_set_t*                           ins,
...
static int api_passwd_entry_create(access_t* perm,
    void*                                    opaque,
    const char*                              op,
    htsmsg_t*                                args,
    htsmsg_t**                               resp) {
...
static void api_ipblock_entry_grid(access_t* perm,
    idnode_set_t*                            ins,
    api_idnode_grid_conf_t*                  conf,
    htsmsg_t*                                args) {
  ipblock_entry_t* ib;
...
static int api_ipblock_entry_create(access_t* perm,
    void*                                     opaque,
    const char*                               op,
    htsmsg_t*                                 args,
    htsmsg_t**                                resp) {
...
static int api_access_entry_userlist(access_t* perm,
    void*                                      opaque,
    const char*                                op,
    htsmsg_t*                                  args,
    htsmsg_t**                                 resp) {
  ...
  if ((is = idnode_find_all(&access_entry_class, NULL))) {
    for (i = 0; i < is->is_count; i++) {
      ...
      if (ae->ae_username != NULL && ae->ae_username[0] != '\0' &&
        ...
        htsmsg_add_msg(l,
            NULL,
            htsmsg_create_key_val(ae->ae_username, ae->ae_username));
...
static void api_access_entry_grid(access_t* perm,
    idnode_set_t*                           ins,
    api_idnode_grid_conf_t*                 conf,
    htsmsg_t*                               args) {
  access_entry_t* ae;
...
static int api_access_entry_create(access_t* perm,
    void*                                    opaque,
    const char*                              op,
    htsmsg_t*                                args,
    htsmsg_t**                               resp) {
