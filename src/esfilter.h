...
#define ESF_CLASS_IS_VALID(i) ((i) >= ESF_CLASS_VIDEO && (i) <= ESF_CLASS_LAST)
...
#define ESF_MASK_VIDEO                                                                      \
  (SCT_MASK(SCT_MPEG2VIDEO) | SCT_MASK(SCT_H264) | SCT_MASK(SCT_VP8) | SCT_MASK(SCT_HEVC) | \
      SCT_MASK(SCT_VP9) | SCT_MASK(SCT_THEORA))

#define ESF_MASK_AUDIO                                                                      \
  (SCT_MASK(SCT_MPEG2AUDIO) | SCT_MASK(SCT_AC3) | SCT_MASK(SCT_AAC) | SCT_MASK(SCT_EAC3) |  \
      SCT_MASK(SCT_MP4A) | SCT_MASK(SCT_VORBIS) | SCT_MASK(SCT_OPUS) | SCT_MASK(SCT_FLAC) | \
      SCT_MASK(SCT_AC4))

#define ESF_MASK_TELETEXT SCT_MASK(SCT_TELETEXT)

#define ESF_MASK_SUBTIT (SCT_MASK(SCT_DVBSUB) | SCT_MASK(SCT_TEXTSUB))

#define ESF_MASK_CA SCT_MASK(SCT_CA)

#define ESF_MASK_OTHER (SCT_MASK(SCT_MPEGTS) | SCT_MASK(SCT_HBBTV) | SCT_MASK(SCT_RDS))
...
esfilter_t* esfilter_create(esfilter_class_t esf_class, const char* uuid, htsmsg_t* conf, int save);
