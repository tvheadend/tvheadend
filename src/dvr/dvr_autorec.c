...
const idclass_t dvr_autorec_entry_class = {
  ...
  .ic_properties = (const property_t[]) {
    ...
    },
    {
      ...
      .desc     = N_("The earliest year for the program. Programs must be equal to or later than this year."),
    ...
    },
    {
      ...
      .desc     = N_("The latest year for the program. Programs must be equal to or earlier than this year."),
      .list     = dvr_autorec_entry_class_year_list,
    ...
    },
    {
      ...
      .desc     = N_("The earliest season for the program. Programs must be equal to or later than this season."),
    ...
    },
    {
      ...
      .desc     = N_("The latest season for the program. Program must be equal to or earlier than this season."),
    ...
    },
    {
      ...
      .desc     = N_("The DVR profile to be used/used by the rule."),
