 ...
 *
 */
static void dvr_insert_fmtstr_before_extension(dvr_config_t* cfg, const char* str) {
 ...
 *
 */
static void dvr_match_and_insert_or_remove(dvr_config_t* cfg, const char* str, int val, int idx) {
...
void dvr_config_changed(dvr_config_t* cfg) {
  ...
  if (cfg->dvr_profile &&
      !strcmp(profile_get_name(cfg->dvr_profile), "htsp")) // htsp is for streaming only
    cfg->dvr_profile = profile_find_by_name("pass", NULL);
}
...
static htsmsg_t* dvr_config_class_save(idnode_t* self, char* filename, size_t fsize) {
...
static int dvr_config_class_perm(idnode_t* self, access_t* a, htsmsg_t* msg_to_write) {
  dvr_config_t*   cfg = (dvr_config_t*)self;
  htsmsg_field_t* f;
...
static void
dvr_config_class_get_title(idnode_t* self, const char* lang, char* dst, size_t dstsize) {
  dvr_config_t* cfg = (dvr_config_t*)self;
  if (!dvr_config_is_default(cfg)) {
...
static htsmsg_t* dvr_config_class_remove_after_playback_list(void* o, const char* lang) {
...
static htsmsg_t* dvr_config_entry_class_update_window_list(void* o, const char* lang) {
  return dvr_entry_class_duration_list(o,
...
static htsmsg_t* dvr_autorec_entry_class_record_list(void* o, const char* lang) {
...
const idclass_t dvr_config_class = {
    ...
    .ic_properties = (const property_t[]){{
        ...
        },
        {
            ...
            .desc = N_("Days to retain information about recordings. Once this period is exceeded, "
