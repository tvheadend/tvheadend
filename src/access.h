...
#define ACCESS_FULL                                                           \
  (ACCESS_STREAMING | ACCESS_ADVANCED_STREAMING | ACCESS_HTSP_STREAMING |     \
      ACCESS_WEB_INTERFACE | ACCESS_RECORDER | ACCESS_HTSP_RECORDER |         \
      ACCESS_ALL_RECORDER | ACCESS_ALL_RW_RECORDER | ACCESS_FAILED_RECORDER | \
      ACCESS_ADMIN)
