...
uint32_t read_bits(bitstream_t* bs, uint32_t num) {
  uint32_t r = 0;
...
uint64_t read_bits64(bitstream_t* bs, uint32_t num) {
  uint64_t r = 0;
...
uint32_t show_bits(bitstream_t* bs, uint32_t num) {
...
uint32_t read_golomb_ue(bitstream_t* bs) {
  uint32_t b;
  int      lzb = -1;
...
int32_t read_golomb_se(bitstream_t* bs) {
  uint32_t v;
  v = read_golomb_ue(bs);
  if (v == 0)
    return 0;
