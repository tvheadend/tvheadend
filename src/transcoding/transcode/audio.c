...
static enum AVSampleFormat _audio_context_sample_fmt(TVHContext* self,
    AVDictionary**                                               opts) {
...
static int _audio_context_sample_rate(TVHContext* self, AVDictionary** opts) {
  ...
  if (!tvh_context_get_int_opt(opts, "sample_rate", &orate) && !orate &&
      sample_rates) {
...
static uint64_t _audio_context_channel_layout(TVHContext* self,
    AVDictionary**                                        opts) {
...
static int tvh_audio_context_open_encoder(TVHContext* self,
    AVDictionary**                                    opts) {
...
static int tvh_audio_context_open_filters(TVHContext* self,
    AVDictionary**                                    opts) {
...
static int tvh_audio_context_open(TVHContext* self,
    TVHOpenPhase                              phase,
    AVDictionary**                            opts) {
  switch (phase) {
    case OPEN_ENCODER:
