...
static int tvh_codec_profile_mp2_open(TVHCodecProfile* self, AVDictionary** opts) {
...
static htsmsg_t* codec_profile_mp2_class_bit_rate_list(void* obj, const char* lang) {
