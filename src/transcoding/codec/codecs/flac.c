...
static int tvh_codec_profile_flac_open(tvh_codec_profile_flac_t* self,
    AVDictionary**                                               opts) {
            ...
            (const property_t[]){
                {
                    ...
                    .desc =
                        N_("Compression level (0-12), -1 means ffmpeg default"),
                    .group    = 3,
                    .get_opts = codec_profile_class_get_opts,
                    .off =
                        offsetof(tvh_codec_profile_flac_t, compression_level),
