...
{
    // pix_fmt
    AV_DICT_SET_PIX_FMT(LS_VAAPI, opts, self->pix_fmt, AV_PIX_FMT_VAAPI);
    return 0;
}
                                  ...
                                  AVDictionary **opts)
{
    ...
    if (self->rc_mode != VAAPI_ENC_PARAMS_RC_SKIP) {
        AV_DICT_SET_INT(LS_VAAPI, opts, "rc_mode", self->rc_mode, AV_DICT_DONT_OVERWRITE);
    }
    int tempSupport = 0;
    switch (self->platform) {
        case VAAPI_ENC_PLATFORM_UNCONSTRAINED:
            ...
            if (self->b_reference) {
                // b_depth
                AV_DICT_SET_INT(LS_VAAPI, opts, "b_depth", self->b_reference, AV_DICT_DONT_OVERWRITE);
            }
            if (self->desired_b_depth >= 0) {
                // max_b_frames
                AV_DICT_SET_INT(LS_VAAPI, opts, "bf", self->desired_b_depth, AV_DICT_DONT_OVERWRITE);
            }
            if (self->bit_rate) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "b", int_bitrate, AV_DICT_DONT_OVERWRITE);
                AV_DICT_SET_INT(LS_VAAPI, opts, "bufsize", int_buffer_size, AV_DICT_DONT_OVERWRITE);
            }
            if (self->max_bit_rate) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "maxrate", int_max_bitrate, AV_DICT_DONT_OVERWRITE);
            }
            if (self->qp) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "qp", self->qp, AV_DICT_DONT_OVERWRITE);
            }
            if (self->quality >= 0) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "quality", self->quality, AV_DICT_DONT_OVERWRITE);
            }
            if (self->low_power) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "low_power", self->low_power, AV_DICT_DONT_OVERWRITE);
            }
            if (self->async_depth) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "async_depth", self->async_depth, AV_DICT_DONT_OVERWRITE);
            }
            if (self->level != -100) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "level", self->level, AV_DICT_DONT_OVERWRITE);
            }
            if (self->qmin) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "qmin", self->qmin, AV_DICT_DONT_OVERWRITE);
            }
            if (self->qmax) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "qmax", self->qmax, AV_DICT_DONT_OVERWRITE);
            }
            break;
        case VAAPI_ENC_PLATFORM_INTEL:
            ...
            if (tempSupport) {
                ...
                // max_b_frames
                AV_DICT_SET_INT(LS_VAAPI, opts, "bf", 0, AV_DICT_DONT_OVERWRITE);
            }
        ...
        case VAAPI_ENC_PLATFORM_AMD:
            ...
            AV_DICT_SET_INT(LS_VAAPI, opts, "bf", 0, 0);
            if (self->quality >= 0) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "quality", self->quality, AV_DICT_DONT_OVERWRITE);
            }
            if (self->low_power) {
    ...
    AV_DICT_SET(LS_VAAPI, opts, "force_key_frames", "expr:gte(t,n_forced*3)", AV_DICT_DONT_OVERWRITE);
    return 0;
}
                                  ...
                                  AVDictionary **opts)
{
    ...
    switch (self->platform) {
        case VAAPI_ENC_PLATFORM_UNCONSTRAINED:
            ...
            if (self->tier >= 0) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "tier", self->tier, AV_DICT_DONT_OVERWRITE);
            }
            if (self->quality >= 0) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "quality", self->quality, AV_DICT_DONT_OVERWRITE);
            }
    ...
    switch (self->platform) {
        case VAAPI_ENC_PLATFORM_UNCONSTRAINED:
            ...
            if (self->global_quality >= 0) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "global_quality", self->global_quality, AV_DICT_DONT_OVERWRITE);
            }
            if (self->low_power) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "low_power", self->low_power, AV_DICT_DONT_OVERWRITE);
            }
            if (self->loop_filter_level >= 0) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "loop_filter_level", self->loop_filter_level, AV_DICT_DONT_OVERWRITE);
            }
            if (self->loop_filter_sharpness >= 0) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "loop_filter_sharpness", self->loop_filter_sharpness, AV_DICT_DONT_OVERWRITE);
            }
            if (self->async_depth) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "async_depth", self->async_depth, AV_DICT_DONT_OVERWRITE);
            }
    ...
    switch (self->platform) {
        case VAAPI_ENC_PLATFORM_UNCONSTRAINED:
            ...
            if (self->super_frame) {
                ...
                AV_DICT_SET(LS_VAAPI, opts, "bsf", "vp9_raw_reorder,vp9_superframe", AV_DICT_DONT_OVERWRITE);
            }
            if (self->bit_rate) {
                AV_DICT_SET_INT(LS_VAAPI, opts, "b", int_bitrate, AV_DICT_DONT_OVERWRITE);
                AV_DICT_SET_INT(LS_VAAPI, opts, "bufsize", int_buffer_size, AV_DICT_DONT_OVERWRITE);
