...
static int tvh_codec_profile_omx_open(tvh_codec_profile_omx_t* self,
    AVDictionary**                                             opts) {
        ...
        .ic_properties =
            (const property_t[]){{
                ...
                },
                {
                    ...
                    .name = N_("Zerocopy"),
                    .desc =
                        N_("Try to avoid copying input frames if possible."),
                    .group    = 5,
                    .opts     = PO_EXPERT,
                    .get_opts = codec_profile_class_get_opts,
...
static void tvh_codec_profile_omx_destroy(TVHCodecProfile* _self) {
