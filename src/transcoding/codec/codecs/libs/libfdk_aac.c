...
static int tvh_codec_profile_libfdk_aac_open(
    tvh_codec_profile_libfdk_aac_t* self,
    AVDictionary**                  opts) {
...
static htsmsg_t* codec_profile_libfdk_aac_class_signaling_list(void* obj,
    const char*                                                      lang) {
        ...
        .ic_properties =
            (const property_t[]){{
                ...
                },
                {
                    ...
                    .get_opts = codec_profile_class_get_opts,
                    .off =
                        offsetof(tvh_codec_profile_libfdk_aac_t, afterburner),
                    .def.i = 1,
                },
                {
                    .type     = PT_BOOL,
