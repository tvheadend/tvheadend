...
static int tvh_codec_profile_libopus_open(tvh_codec_profile_libopus_t* self,
    AVDictionary**                                                     opts) {
...
static htsmsg_t* codec_profile_libopus_class_vbr_list(void* obj,
    const char*                                             lang) {
...
static htsmsg_t* codec_profile_libopus_class_application_list(void* obj,
    const char*                                                     lang) {
  static const struct strtab tab[] = {
      {N_("voip: Favor improved speech intelligibility"),
