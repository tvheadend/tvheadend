...
static int tvh_codec_profile_libvpx_open(tvh_codec_profile_libvpx_t* self,
    AVDictionary**                                                   opts) {
...
static htsmsg_t* codec_profile_libvpx_class_deadline_list(void* obj,
    const char*                                                 lang) {
...
static htsmsg_t* codec_profile_libvpx_class_tune_list(void* obj,
    const char*                                             lang) {
  static const struct strtab tab[] = {{N_("psnr"), VP8_TUNE_PSNR},
