...
static int tvh_codec_profile_libvpx_open(tvh_codec_profile_libvpx_t* self, AVDictionary** opts) {
...
static htsmsg_t* codec_profile_libvpx_class_deadline_list(void* obj, const char* lang) {
  static const struct strtab tab[] = {{N_("best"), VPX_DL_BEST_QUALITY},
      {N_("good"), VPX_DL_GOOD_QUALITY},
      {N_("realtime"), VPX_DL_REALTIME}};
  return strtab2htsmsg(tab, 1, lang);
}

static htsmsg_t* codec_profile_libvpx_class_tune_list(void* obj, const char* lang) {
  static const struct strtab tab[] = {{N_("psnr"), VP8_TUNE_PSNR}, {N_("ssim"), VP8_TUNE_SSIM}};
  return strtab2htsmsg(tab, 1, lang);
}
