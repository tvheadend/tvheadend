...
static htsmsg_t* strlist2htsmsg(const char* const* values) {
...
static int tvh_codec_profile_libx26x_open(tvh_codec_profile_libx26x_t* self,
    AVDictionary**                                                     opts) {
        ...
        .ic_properties =
            (const property_t[]){{
                                 ...
                                 },
                {
                    ...
                    .desc = N_(
                        "Select the quality for constant quality mode [0-51]."),
                    .group    = 3,
                    .get_opts = codec_profile_class_get_opts,
...
static void tvh_codec_profile_libx265_destroy(TVHCodecProfile* _self) {
...
static int tvh_codec_profile_libx264_open(tvh_codec_profile_libx26x_t* self,
    AVDictionary**                                                     opts) {
  // bit_rate or crf
  if (self->bit_rate) {
...
static htsmsg_t* codec_profile_libx264_class_preset_list(void* obj,
    const char*                                                lang) {
  return strlist2htsmsg(x264_preset_names);
}

static htsmsg_t* codec_profile_libx264_class_tune_list(void* obj,
    const char*                                              lang) {
            ...
            (const property_t[]){
                {
                    ...
                    .name = N_("Preset"),
                    .desc =
                        N_("Set the encoding preset (cf. x264 --fullhelp)."),
                    .group    = 5,
                    .opts     = PO_EXPERT,
                    .get_opts = codec_profile_class_get_opts,
                ...
                },
                {
                    ...
                    .name = N_("Tune"),
                    .desc =
                        N_("Tune the encoding params (cf. x264 --fullhelp)."),
                    .group    = 5,
                    .opts     = PO_EXPERT,
                    .get_opts = codec_profile_class_get_opts,
                ...
                },
                {
                    ...
                    .name = N_("Parameters"),
                    .desc =
                        N_("Override the configuration using a ':' separated "
...
static int tvh_codec_profile_libx265_open(tvh_codec_profile_libx26x_t* self,
    AVDictionary**                                                     opts) {
  // bit_rate or crf
  if (self->bit_rate) {
    AV_DICT_SET_BIT_RATE(opts, self->bit_rate);
...
static htsmsg_t* codec_profile_libx265_class_preset_list(void* obj,
    const char*                                                lang) {
  return strlist2htsmsg(x265_preset_names);
}

static htsmsg_t* codec_profile_libx265_class_tune_list(void* obj,
    const char*                                              lang) {
