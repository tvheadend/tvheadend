...
static int tvh_codec_profile_libx26x_open(tvh_codec_profile_libx26x_t* self, AVDictionary** opts) {
...
static int tvh_codec_profile_libx264_open(tvh_codec_profile_libx26x_t* self, AVDictionary** opts) {
  // bit_rate or crf
  if (self->bit_rate) {
...
static htsmsg_t* codec_profile_libx264_class_preset_list(void* obj, const char* lang) {
  return strlist2htsmsg(x264_preset_names);
}

static htsmsg_t* codec_profile_libx264_class_tune_list(void* obj, const char* lang) {
...
static int tvh_codec_profile_libx265_open(tvh_codec_profile_libx26x_t* self, AVDictionary** opts) {
  // bit_rate or crf
  if (self->bit_rate) {
    AV_DICT_SET_BIT_RATE(opts, self->bit_rate);
  } else {
...
static htsmsg_t* codec_profile_libx265_class_preset_list(void* obj, const char* lang) {
  return strlist2htsmsg(x265_preset_names);
}

static htsmsg_t* codec_profile_libx265_class_tune_list(void* obj, const char* lang) {
