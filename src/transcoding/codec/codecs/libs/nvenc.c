...
static int tvh_codec_profile_nvenc_open(tvh_codec_profile_nvenc_t* self,
    AVDictionary**                                                 opts) {
...
static htsmsg_t* codec_profile_nvenc_class_profile_list(void* obj,
    const char*                                               lang) {
  TVHCodec* codec = tvh_codec_profile_get_codec(obj);
  return tvh_codec_get_list(codec, profiles);
}

static htsmsg_t* codec_profile_nvenc_class_preset_list(void* obj,
    const char*                                              lang) {
...
static htsmsg_t* codec_profile_nvenc_class_rc_list(void* obj,
    const char*                                          lang) {
  static const struct strtab tab[] = {
...
static int tvh_codec_profile_nvenc_h264_open(tvh_codec_profile_nvenc_t* self,
    AVDictionary**                                                      opts) {
...
static htsmsg_t* codec_profile_nvenc_class_level_list_h264(void* obj,
    const char*                                                  lang) {
  static const struct strtab tab[] = {
...
static int tvh_codec_profile_nvenc_hevc_open(tvh_codec_profile_nvenc_t* self,
    AVDictionary**                                                      opts) {
  static const struct strtab profiletab[] = {
...
static htsmsg_t* codec_profile_nvenc_class_level_list_hevc(void* obj,
    const char*                                                  lang) {
  static const struct strtab tab[] = {
      {N_("Auto"), NV_ENC_LEVEL_AUTOSELECT},
