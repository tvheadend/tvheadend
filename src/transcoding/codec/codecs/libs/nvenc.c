                             ...
                             AVDictionary **opts)
{
    ...
    double out_height = (self->size.den > 0) ? (double)(self->size.den) : 480.0;
    int int_bitrate = (int)((self->bit_rate) * 1024.0 * (1.0 + (self->bit_rate_scale_factor * (out_height - 480.0) / 480.0)));
    int int_max_bitrate = (int)((self->max_bit_rate) * 1024.0 * (1.0 + (self->bit_rate_scale_factor * (out_height - 480.0) / 480.0)));
    int int_qp = self->qp;
    int int_cq = self->cq;
