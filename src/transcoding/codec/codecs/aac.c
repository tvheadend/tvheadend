...
static const uint64_t aac_channel_layouts[] = {AV_CH_LAYOUT_MONO,
    AV_CH_LAYOUT_STEREO,
...
static int tvh_codec_profile_aac_open(tvh_codec_profile_aac_t* self, AVDictionary** opts) {
...
static htsmsg_t* codec_profile_aac_class_coder_list(void* obj, const char* lang) {
...
static void tvh_codec_profile_aac_destroy(TVHCodecProfile* _self) {
