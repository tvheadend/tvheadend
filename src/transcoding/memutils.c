...
static char* str_add(const char* sep, const char* str) {
...
static char* str_vjoin(const char* separator, va_list ap) {
...
int str_snprintf(char* str, size_t size, const char* format, ...) {
  va_list ap;
  va_start(ap, format);
...
uint8_t* pktbuf_copy_data(pktbuf_t* pb) {
