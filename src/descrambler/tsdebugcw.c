 ...
 *
 */
static int tsdebugcw_ecm_reset(th_descrambler_t* th) {
  return 1;
}
 ...
 */
static void tsdebugcw_service_destroy(th_descrambler_t* td) {
 ...
 */
void tsdebugcw_service_start(service_t* t) {
  tsdebugcw_service_t* ct;
  th_descrambler_t*    td;
  char                 buf[128];
 ...
 *
 */
void tsdebugcw_new_keys(service_t* t,
    int                            type,
    uint16_t                       pid,
    uint8_t*                       odd,
    uint8_t*                       even) {
