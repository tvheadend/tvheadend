 ...
 * Class masks
 */
uint32_t esfilterclsmask[ESF_CLASS_LAST + 1] = {0,
    ESF_MASK_VIDEO,
    ESF_MASK_AUDIO,
    ESF_MASK_TELETEXT,
    ESF_MASK_SUBTIT,
...
static const idclass_t* esfilter_classes[ESF_CLASS_LAST + 1] = {NULL,
...
static struct strtab esfilteractiontab[] = {{"NONE", ESFA_NONE},
    {"USE", ESFA_USE},
...
static void esfilter_reindex(esfilter_class_t cls) {
  esfilter_t* esf;
  int         i = 1;
...
static int esfilter_cmp(esfilter_t* a, esfilter_t* b) {
  return a->esf_index - b->esf_index;
}

esfilter_t* esfilter_create(esfilter_class_t cls, const char* uuid, htsmsg_t* conf, int save) {
...
static void esfilter_delete(esfilter_t* esf, int delconf) {
...
static htsmsg_t* esfilter_class_save(idnode_t* self, char* filename, size_t fsize) {
...
static void esfilter_class_delete(idnode_t* self) {
  esfilter_t* esf = (esfilter_t*)self;
  esfilter_delete(esf, 1);
}

static void esfilter_class_moveup(idnode_t* self) {
  esfilter_t* esf  = (esfilter_t*)self;
...
static void esfilter_class_movedown(idnode_t* self) {
  esfilter_t* esf  = (esfilter_t*)self;
...
static const void* esfilter_class_type_get(void* o) {
  esfilter_t* esf = o;
...
static char* esfilter_class_type_rend(void* o, const char* lang) {
  char*       str;
  htsmsg_t*   l   = htsmsg_create_list();
  esfilter_t* esf = o;
  int         i;
...
static int esfilter_class_type_set_(void* o, const void* v, esfilter_class_t cls) {
  esfilter_t*     esf   = o;
...
static htsmsg_t* esfilter_class_type_enum_(void* o, const char* lang, esfilter_class_t cls) {
  ...
  for (i = SCT_UNKNOWN; i <= SCT_LAST; i++) {
    if (mask & SCT_MASK(i)) {
      ...
      htsmsg_add_str(e,
          "val",
          i == SCT_UNKNOWN ? tvh_gettext_lang(lang, any) : streaming_component_type2txt(i));
...
static const void* esfilter_class_language_get(void* o) {
...
static int esfilter_class_language_set(void* o, const void* v) {
  esfilter_t* esf = o;
  const char* s   = v;
  char        n[4];
  int         save;
...
static htsmsg_t* esfilter_class_language_enum(void* o, const char* lang) {
  htsmsg_t*          l   = htsmsg_create_list();
...
static const void* esfilter_class_service_get(void* o) {
  static __thread char* ret;
  esfilter_t*           esf = o;
  ret                       = esf->esf_service;
  return &ret;
...
static int esfilter_class_service_set(void* o, const void* v) {
  esfilter_t* esf  = o;
  const char* s    = v;
  int         save = 0;
...
static htsmsg_t* esfilter_class_service_enum(void* o, const char* lang) {
...
static int esfilter_build_ca_cmp(const void* _a, const void* _b) {
...
static htsmsg_t* esfilter_build_ca_enum(int provider) {
  htsmsg_t*            l;
  ...
  for (i = 0; i < count; i++) {
    ...
    if (!provider)
      snprintf(buf2, sizeof(buf2), "%04x - %s", a[i], caid2name(a[i]));
    htsmsg_add_msg(l, NULL, htsmsg_create_key_val(buf, provider ? buf : buf2));
  }
  return l;
}

static const void* esfilter_class_caid_get(void* o) {
  static __thread char* ret;
...
static int esfilter_class_caid_set(void* o, const void* v) {
  esfilter_t* esf = o;
  uint16_t    u;
  int         save = 0;
  u                = strtol(v, NULL, 16);
...
static htsmsg_t* esfilter_class_caid_enum(void* o, const char* lang) {
  return esfilter_build_ca_enum(0);
}

static const void* esfilter_class_caprovider_get(void* o) {
  static __thread char* ret;
  static __thread char  buf[16];
  esfilter_t*           esf = o;
...
static int esfilter_class_caprovider_set(void* o, const void* v) {
  esfilter_t* esf = o;
  uint32_t    u;
  int         save = 0;
...
static htsmsg_t* esfilter_class_caprovider_enum(void* o, const char* lang) {
  return esfilter_build_ca_enum(1);
}

static const void* esfilter_class_action_get(void* o) {
  esfilter_t* esf = o;
  return &esf->esf_action;
}

static int esfilter_class_action_set(void* o, const void* v) {
  esfilter_t* esf  = o;
  int         n    = *(int*)v;
  int         save = 0;
...
static htsmsg_t* esfilter_class_action_enum(void* o, const char* lang) {
  htsmsg_t* l = htsmsg_create_list();
  int       i;
...
const idclass_t esfilter_class = {.ic_class = "esfilter",
...
const idclass_t esfilter_class_video = {.ic_super = &esfilter_class,
...
const idclass_t esfilter_class_audio = {.ic_super = &esfilter_class,
...
const idclass_t esfilter_class_teletext = {.ic_super = &esfilter_class,
...
const idclass_t esfilter_class_subtit = {.ic_super = &esfilter_class,
...
const idclass_t esfilter_class_ca = {.ic_super = &esfilter_class,
...
const idclass_t esfilter_class_other = {.ic_super = &esfilter_class,
