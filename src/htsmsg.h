 ...
 */
static inline void htsmsg_add_u32(htsmsg_t* msg, const char* name, uint32_t u32) {
 ...
 */
static inline int htsmsg_set_u32(htsmsg_t* msg, const char* name, uint32_t u32) {
 ...
 */
static inline void htsmsg_add_s32(htsmsg_t* msg, const char* name, int32_t s32) {
 ...
 * Add/update an integer field
 */
static inline int htsmsg_set_s32(htsmsg_t* msg, const char* name, int32_t s32) {
 ...
 */
htsmsg_t* htsmsg_get_map_multi(htsmsg_t* msg, ...) __attribute__((__sentinel__(0)));

/**
 * Traverse a hierarchy of htsmsg's to find a specific child.
 */
const char* htsmsg_get_str_multi(htsmsg_t* msg, ...) __attribute__((__sentinel__(0)));
