...
const idclass_t obj_a_class = {.ic_class = "obj_a",
...
const idclass_t obj_b_class = {.ic_super = &obj_a_class,
    .ic_class                            = "obj_b",
...
static void obj_a_func1(void* self) {
  obj_a_t* a = self;
  printf("a->a_int1 = %d\n", a->a_int1);
}

static obj_a_t* obj_a_create1(size_t alloc, const idclass_t* class, const char* uuid) {
...
static void obj_b_func1(void* self) {
  obj_b_t* b = self;
  printf("b->a_int1 = %d\n", b->a_int1);
  printf("b->b_int2 = %d\n", b->b_int2);
}
