...
#define SCT_ISVIDEO(t)                                           \
  ((t) == SCT_MPEG2VIDEO || (t) == SCT_H264 || (t) == SCT_VP8 || \
      (t) == SCT_HEVC || (t) == SCT_VP9 || (t) == SCT_THEORA)

#define SCT_ISAUDIO(t)                                           \
  ((t) == SCT_MPEG2AUDIO || (t) == SCT_AC3 || (t) == SCT_AAC ||  \
      (t) == SCT_MP4A || (t) == SCT_EAC3 || (t) == SCT_VORBIS || \
      (t) == SCT_OPUS || (t) == SCT_FLAC || (t) == SCT_AC4)
...
elementary_stream_t* elementary_stream_type_find(elementary_set_t* set,
    streaming_component_type_t                                     type);
static inline elementary_stream_t* elementary_stream_find(elementary_set_t* set,
    int pid) {
