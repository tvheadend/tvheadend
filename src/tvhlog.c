...
tvhlog_subsys_t tvhlog_subsystems[] = {
  ...
  [LS_MP2]           = { "mp2",           N_("MP2") },
  [LS_AAC]           = { "aac",           N_("AAC") },
  [LS_FLAC]          = { "flac",          N_("FLAC") },
  [LS_LIBFDKAAC]     = { "libfdk-aac",    N_("LIB DFC_AAC") },
  [LS_LIBOPUS]       = { "libopus",       N_("LIB OPUS") },
  [LS_LIBTHEORA]     = { "libtheora",     N_("LIB THEORA") },
  [LS_LIBVORBIS]     = { "libvorbis",     N_("LIB VORBIS") },
  [LS_VORBIS]        = { "vorbis",        N_("VORBIS") },
  [LS_MPEG2VIDEO]    = { "mpeg2video",    N_("MPEG2 VIDEO") },
  [LS_LIBVPX]        = { "libvpx",        N_("LIB VPX") },
  [LS_LIBX26X]       = { "libx26x",       N_("LIB x264_x265") },
  [LS_NVENC]         = { "nvenc",         N_("NVENC") },
  [LS_OMX]           = { "omx",           N_("OMX") },
