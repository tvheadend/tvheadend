...
typedef struct epggrab_ota_module_ops {
  ...
  void (*done)(void* m);
  int (*tune)(epggrab_ota_map_t* map,
 ...
 */
epggrab_ota_mux_t* epggrab_ota_find(epggrab_module_ota_t* mod,
    struct mpegts_mux*                                    dm);
epggrab_ota_mux_t* epggrab_ota_create(epggrab_module_ota_t* mod,
    struct mpegts_mux*                                      dm);
...
size_t freesat_huffman_decode(char* dst,
    size_t*                         dstlen,
    const uint8_t*                  src,
    size_t                          srclen);
