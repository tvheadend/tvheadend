...
static void epggrab_mod_class_title(idnode_t* self, const char* lang, char* dst, size_t dstsize) {
...
static htsmsg_t* epggrab_module_ota_scrapper_config_list(void* o, const char* lang) {
...
const idclass_t epggrab_mod_ota_scraper_class = {.ic_super = &epggrab_mod_ota_class,
